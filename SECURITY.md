...
Текущая поддерживаемая версия — **LexPack 0.8.3**. Исправления безопасности готовятся для актуальной версии в основной ветке. Старые распакованные копии расширения не обновляются автоматически: после получения исправления замените файлы и нажмите «Обновить» в `chrome://extensions`.
